...
# Lower-overhead state protection; combinational SETs remain unprotected.
tmr_mode = "RegisterTMR"
...
Use `tmrx_*` attributes when you want to keep configuration close to the RTL.
The full list of supported attributes and their meanings is in the xref:configuration-reference.adoc[Configuration Reference].
