...
constexpr const char cfg_correction_feedback_key_name[] = "correction_feedback";
constexpr const char cfg_ff_port_mappings_key_name[] = "ff_port_mappings";
constexpr const char cfg_ff_clock_port_key_name[] = "clock_port";
constexpr const char cfg_ff_data_port_key_name[] = "data_port";
constexpr const char cfg_ff_output_port_key_name[] = "output_port";
constexpr const char cfg_ff_enable_port_key_name[] = "enable_port";
constexpr const char cfg_ff_enable_active_high_key_name[] = "enable_active_high";
...
constexpr const char cfg_correction_feedback_attr_name[] = "\\tmrx_correction_feedback";
